...
class Search extends React.Component {
   ...
   onSubmit = (e) => {
      ...
      this.props.searchQueryProp(this.state.name);
      this.setState({
         name: null,
      })
   }
